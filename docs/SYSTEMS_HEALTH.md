...
| This site | `AGENTS.md`, `README.md` | chefwho.codes agent pass-through |
| Recovery pipeline house | `docs/RECOVERY_HOUSE.md`, `swm-recovery/`, `forensic-archive/` | Separate GitHub house; guests here until transferred |
